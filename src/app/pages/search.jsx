    ...
    <div className="pt-24 px-4 md:px-12 min-h-screen">
      <div className="max-w-2xl mx-auto mb-8">
        <input
          ...
          autoFocus
          className="w-full px-6 py-4 bg-bg-elevated/70 border border-gray-600 rounded-lg text-white text-lg placeholder-gray-400 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-colors"
        />
      </div>
